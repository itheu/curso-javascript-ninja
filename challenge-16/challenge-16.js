(function () {
    ...
    */
    ...
    var fullName = 'matheus-felipe-lima-rodrigues'
    ...
    */
    console.log('\nMeus amigos:');
    var web = ['Anibal', 'Bianca', 'Felix', 'Glauber', 'Michael'];
    var frase = web.reduce(function (acumulado, atual, index) {
        var separator = web.length - 1 === index ? ' e ' : ', '
