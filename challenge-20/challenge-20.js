...
o e-mail que foi entrado no campo de "Email" por parâmetro. (A função
   ...
   $button.addEventListener('click', function(event) {
     // Este evento serve para que o navegador não faça o padrão da página, que é recarregar após o submit
     event.preventDefault();
     // verificando se tem valor no campo de nome
     !$inputUsername.value ? alert('Preencha o nome do usuário!') : 'OK'
     // verificando se tem valor no campo de email
     !$inputEmail.value ? alert('Preencha o e-mail!') : 'OK'
     // verificando se tem valor no campo de mensagem
     !$message.value ? alert('Preencha a mensagem!') : 'OK'
     // verificando se o e-mail é valido 
     !isValidEmail($inputEmail.value) ? alert('Entre com um e-mail válido') : 'OK'
     // confirmando o envio do formulário
